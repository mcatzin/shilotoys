...
This project is a simple eCommerce website with Admin management system and user registration to practice vanilla JavaScript with Node.js and MongoDB. Applyied JWT Authentication and responsive design principles.

## Learning Outcomes

- Learn how to implement third-party payment systems like PayPal. The setup took longer than I expected because of PayPal credentials and integration.
- Improved using MongoDB aggregation operations to process data and return results.
- Improved using JWT Authentication for handling payment process.
- The admin dashboard was the most challenging process but the most rewarded outcome. Getting the orders and products integrated with the payment process took longer than I expected.
